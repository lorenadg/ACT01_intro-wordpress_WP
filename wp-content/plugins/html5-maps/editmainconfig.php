...
<form method="POST">
    ...
    <fieldset>
        ...
        <span class="title"><?php _e( 'Map name:', 'html5-maps' ) ?> </span><input type="text" name="options[name]" value="<?php echo $options[$map_id]['name']; ?>" />
        <span class="tipsy-q" original-title="<?php esc_attr_e( 'Name of the map', 'html5-maps' ) ?>">[?]</span><div class="colorpicker"></div>


        <span class="title"><?php _e( 'Borders Color:', 'html5-maps' ) ?> </span><input class="color" type="text" name="options[borderColor]" value="<?php echo $options[$map_id]['borderColor']; ?>" style="background-color: #<?php echo $options[$map_id]['borderColor']; ?>" />
        ...
        <span class="title"><?php _e( 'Map width:', 'html5-maps' ) ?> </span><input class="span2" type="text" name="options[mapWidth]" value="<?php echo $options[$map_id]['mapWidth']; ?>" />
        <span class="tipsy-q" original-title="<?php esc_attr_e( 'The width of the map', 'html5-maps' ) ?>">[?]</span>
        <div class="clear"></div>

        <span class="title"><?php _e( 'Map height:', 'html5-maps' ) ?> </span><input class="span2" type="text" name="options[mapHeight]" value="<?php echo $options[$map_id]['mapHeight']; ?>" />
        <span class="tipsy-q" original-title="<?php esc_attr_e( 'The height of the map', 'html5-maps' ) ?>">[?]</span>
        <div class="clear"></div>

        <span class="title"><?php _e( 'Max width:', 'html5-maps' ) ?> </span><input class="span2" type="text" name="options[maxWidth]" value="<?php echo $options[$map_id]['maxWidth']; ?>" disabled />
