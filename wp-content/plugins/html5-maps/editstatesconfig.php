...
<div class="left-block">
	...
	if($sId) {
		...
		<div style="" id="stateinfo-<?php echo $vals['id']?>" class="stateinfo">
		    <span class="title"><?php _e( 'Name:', 'html5-maps' ) ?> </span><input class="" type="text" name="name[<?php echo $vals['id']?>]" value="<?php echo $vals['name']?>" />
		    <span class="tipsy-q" original-title="<?php esc_attr_e( 'Name of Area', 'html5-maps' ) ?>">[?]</span>
		    <div class="clear"></div>

		    <span class="title"><?php _e( 'Shortname:', 'html5-maps' ) ?> </span><input class="" type="text" name="shortname[<?php echo $vals['id']?>]" value="<?php echo $vals['shortname']?>" />
			...
			<span class="title"><?php _e( 'URL:', 'html5-maps' ) ?> </span><input style="width: 240px;" class="" type="text" name="URL[<?php echo $vals['id']?>]" id="URL<?php echo $vals['id']?>" value="<?php echo $vals['link']?>" />
		    ...
		    {
			?>
			<span class="title"><?php _e( 'Area color:', 'html5-maps' ) ?> </span><input class="color colorSimple" type="text" name="color[<?php echo $vals['id']?>]" value="<?php echo $vals['color_map']?>" style="background-color: #<?php echo $vals['color_map']?>"  />
			...
			<br />
			<span class="title"><?php _e( 'Area hover color:', 'html5-maps' ) ?> </span><input class="color colorOver" type="text" name="color_[<?php echo $vals['id']?>]" value="<?php echo $vals['color_map_over']?>" style="background-color: #<?php echo $vals['color_map_over']?>"  />
...
<div class="qanner" style="margin-top: 27px;">
            <a href="https://www.fla-shop.com/wordpressmaps.php?utm_source=html5-maps-plugin&utm_medium=dashboard&utm_campaign=banner" target="_blank"><img src="<?php echo WP_PLUGIN_URL.'/html5-maps/static/' ?>html5maps_img.png<?php echo "?r=".time();?>" border="0" width="160" height="601"></a>
</div>
